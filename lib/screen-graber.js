module.exports.start = function(program, colors, fs) {
  ...
  function appendImages() {
    im.convert([dir + '/' + prefix + '/*.png', '+append', dir + '/' + prefix + '/' + prefix + '_h.png'], function(err, stdout) {
      ...
      console.log('\u2714 Creating horizontal image: '.green + (prefix + '/' + prefix + '_h.png').cyan);
    });
    ...
    im.convert([dir + '/' + prefix + '/*.png', '-append', dir + '/' + prefix + '/' + prefix + '_v.png'], function(err, stdout) {
      ...
      console.log('\u2714 Creating vertical image: '.green + (prefix + '/' + prefix + '_v.png').cyan);
      console.log('\n[INFO] Append images have been created: '.yellow, '\u2714'.green, new Date(), '\n');
    });
  }
};
